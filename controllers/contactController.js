...
exports.submitContact = async function (req, res, next) {
  ...
  try {
    const promise1 = transport.sendMail({
      ...
      <p>We appreciate your interest in ${doesPetExist.name}. One of our staff members will reach out to you soon. For your records, below is a copy of the message you sent us:</p>
